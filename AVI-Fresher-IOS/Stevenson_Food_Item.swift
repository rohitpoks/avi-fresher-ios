...
class Allergens : Decodable, Equatable {
...
class Nutritionals : Decodable, Equatable {
...
class StevensonFoodItem : Decodable {
    let id: Int
    let name: String
    let date: String
    let image: String
    ...
    init(id: Int, name: String, date: String, image: String, description: String, categoryName: String, stationName: String, stationOrder: Int, allergens: [Allergens], nutritionals: Nutritionals) {
        self.id = id
        self.name = name
        self.date = date
        self.image = image
